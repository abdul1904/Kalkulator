...
if(selected == "Rangkaian Fixed Bias") :
    ...
    h=st.number_input("Masukkan nilai Tegangan Input (Volt)",0.0000)
    ...
    if hitung :
        ...
        vo=av*h
        vo1=av1*h
        st.write("HASIL PERHITUNGAN JIKA RO TIDAK DIKETAHUI")
        ...
        st.success(f"Nilai Tegangan Output Sebesar = {vo} Volt")
        ...
        st.success(f"Nilai Tegangan Output Sebesar = {vo1} Volt")
...
if(selected == "Rangkaian Voltage Divider Bias") :
    ...
    z=st.number_input("Masukkan nilai Tegangan Input (Volt)",0.0000)
